...
let elementFinder: ElementFinder = element(By.css('.e-card'));
    ...
    it('Basic-card', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'card/basic.html', Helper.card);
        browser.sleep(1000);
    ...
    it('Vertical-card', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'card/vertical.html', Helper.card);
        await element(By.css('.e-card')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(3000);
    ...
    it('Horizontal-card', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'card/horizontal.html', Helper.card);
        await element(By.css('.e-card')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(3000);
    ...
    it('Swipeable-card', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'card/swipeable.html', Helper.card);
        browser.sleep(2000);
        await element(By.css('.e-card')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
    ...
    it('Flip-card', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'card/flip.html', Helper.card);
        browser.sleep(1000);
        await element(By.css('.e-card')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
    ...
    it('Reveal-card', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'card/reveal.html', Helper.card);
        await element(By.css('.e-card')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(3000);
    ...
    it('Tile-view', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'card/tile.html', Helper.card);
        browser.sleep(1000);
