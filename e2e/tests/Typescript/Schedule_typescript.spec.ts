...
let elementFinder: ElementFinder = element(By.css('.e-schedule'));
    ...
    it('Overview', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/overview.html', Helper.schedule);
    ...
    it('Default', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/default.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Localdata', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/local-data.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Remotedata', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/remote-data.html', Helper.schedule);
    ...
    it('Syncgooglecalendar', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/calendar-integration.html', Helper.schedule);
    ...
    it('Recurringevents', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/recurrence-events.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Blockevent', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/block-events.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Search-event', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/search-events.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Timezone', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/timezone.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Dragdrop', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/external-drag-drop.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Inline-editor', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/inline-editing.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Virtual-scroll', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/virtual-scrolling.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Basicview', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/views.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Timelineview', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/timeline.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Agendaview', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/agenda.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Monthagendaview', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/month-agenda.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Yearview', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/year.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Individualview', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/views-configuration.html', Helper.schedule);
        browser.sleep(1000);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
    ...
    it('Viewinterval', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/extended-views.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Roomscheduler', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/timeline-resources.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Farecal', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/resources.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Resources', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/resource.html', Helper.schedule);
    ...
    it('Sharedevent', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/group-editing.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Differentworkdays', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/group-custom-work-days.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Showandhide', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/add-remove-resources.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Rowautoheight', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/adaptive-rows.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Horizontalgroup', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/resource-grouping.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Timelinegroup', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/timeline-resource-grouping.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Datewisegroup', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/group-by-date.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Hierarchicalgroup', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/group-by-child.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Dateheader', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/date-header-template.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Events', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/event-template.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Tooltip', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/tooltip.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Quickinfo', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/quick-info-template.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Fieldvalidation', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/editor-validation.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Additionalfield', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/editor-custom-field.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Editortemplate', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/editor-template.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Header-rows', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/header-rows.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Time-scale', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/time-scale.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Context-menu', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/context-menu.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Header-bar', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/header-bar.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Scroll-time', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/scroll-to.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Work-days', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/work-days.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Hide-nonworkdays', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/hide-weekend.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
   ...
   it('Work-hour', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/work-hour.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Day-hourlimit', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/start-end-hour.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Cell-dimension', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/cell-dimension.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Excel-exporting', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/excel-export.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Exportandimportics', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/calendar-export-import.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Print', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/print.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Keyboard-intercation', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/keyboard-interaction.html', Helper.schedule);
        await element(By.css('.e-schedule')).isDisplayed().then((flag: boolean) => {
            expect(flag).toEqual(true);
        });
        browser.sleep(1000);
    ...
    it('Events', async (done: DoneFn) => {
        Helper.getAndWait(Helper.tsUrl + 'schedule/events.html', Helper.schedule);
